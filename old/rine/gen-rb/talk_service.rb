...
module TalkService
  class Client
    ...
    def registerDeviceWithoutPhoneNumberWithIdentityCredential(region, udidHash, deviceInfo, provider, identifier, verifier, mid)
    ...
    def send_registerDeviceWithoutPhoneNumberWithIdentityCredential(region, udidHash, deviceInfo, provider, identifier, verifier, mid)
      send_message('registerDeviceWithoutPhoneNumberWithIdentityCredential', RegisterDeviceWithoutPhoneNumberWithIdentityCredential_args, :region => region, :udidHash => udidHash, :deviceInfo => deviceInfo, :provider => provider, :identifier => identifier, :verifier => verifier, :mid => mid)
    end
    ...
    def setIdentityCredential(provider, identifier, verifier)
      send_setIdentityCredential(provider, identifier, verifier)
      recv_setIdentityCredential()
    end

    def send_setIdentityCredential(provider, identifier, verifier)
      send_message('setIdentityCredential', SetIdentityCredential_args, :provider => provider, :identifier => identifier, :verifier => verifier)
    end
    ...
    def startVerification(region, carrier, phone, udidHash, deviceInfo, networkCode, mid, locale)
      send_startVerification(region, carrier, phone, udidHash, deviceInfo, networkCode, mid, locale)
      return recv_startVerification()
    end

    def send_startVerification(region, carrier, phone, udidHash, deviceInfo, networkCode, mid, locale)
      send_message('startVerification', StartVerification_args, :region => region, :carrier => carrier, :phone => phone, :udidHash => udidHash, :deviceInfo => deviceInfo, :networkCode => networkCode, :mid => mid, :locale => locale)
    end
  ...
  class Processor
    ...
    def process_registerDeviceWithoutPhoneNumberWithIdentityCredential(seqid, iprot, oprot)
      ...
      begin
        result.success = @handler.registerDeviceWithoutPhoneNumberWithIdentityCredential(args.region, args.udidHash, args.deviceInfo, args.provider, args.identifier, args.verifier, args.mid)
      rescue TalkException => e
        result.e = e
      end
    ...
    def process_setIdentityCredential(seqid, iprot, oprot)
      ...
      begin
        @handler.setIdentityCredential(args.provider, args.identifier, args.verifier)
      rescue TalkException => e
        result.e = e
      end
    ...
    def process_startVerification(seqid, iprot, oprot)
      ...
      begin
        result.success = @handler.startVerification(args.region, args.carrier, args.phone, args.udidHash, args.deviceInfo, args.networkCode, args.mid, args.locale)
      rescue TalkException => e
        result.e = e
      end
